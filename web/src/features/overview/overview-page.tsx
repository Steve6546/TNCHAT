...
import { Activity, BarChart3, Box, Clock3, Database, Gauge, RotateCw, Send, Sparkles } from 'lucide-react';
...
import { errorMessage, formatCompact, formatDate, formatDay, formatNumber, formatPercent } from '../../lib/utils';
      ...
      <Card className="mt-4">
        <CardHeader className="flex-row items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">آخر 25 طلباً عبر البوابة</p>
          </div>
