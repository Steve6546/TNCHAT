...
const TROUBLESHOOTING: { code: string; meaning: string; fix: string }[] = [
  ...
  {
    code: '404',
    meaning: 'عنوان القناة لا يطابق أي مسار لدى المزوّد.',
    fix: 'افتح القناة وتحقق من Base URL. للأنواع الجاهزة اكتب الجذر فقط (مثال: https://api.example.com/v1) — وإن نسيت /v1 فزر الفحص يجربه ويحفظه تلقائياً. لمزوّد بمسار غير مألوف، اختر النوع «مخصّص» واكتب المسار الكامل كما في وثائقه.',
  },
  {
    code: '502',
        ...
        <CardContent>
          <ol className="space-y-4">
            <Step index={1} title="أضف قناة (مزوّد علوي)">
              ...
              استخدم زر الفحص للتأكد أن الاتصال يعمل قبل المتابعة. لأي مزوّد آخر — مدفوعاً كان أو
              مجانياً — اختر النوع «مخصّص» واكتب المسار الكامل وطريقة المصادقة وأي ترويسات يطلبها.
            </Step>
